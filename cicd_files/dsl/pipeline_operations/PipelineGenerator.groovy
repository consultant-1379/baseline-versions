...
def pipelineBeingGeneratedName = 'baseline-versions_Pipeline_Generator'

pipelineJob(pipelineBeingGeneratedName) {
    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName,
        "<p>The ${pipelineBeingGeneratedName} job generates the Jenkins Pipelines for the Baseline Versions repo.</p>",
